...
async fn should_replay_failed_writes_rtl_433() {
    let mut reader = test_reader::RTL433TestReader {
        ...
        readings: vec![
            ...
            String::from("{\"time\" : \"2021-12-15T20:49:14Z\", \"model\" : \"Acurite-5n1\", \"message_type\" : 49, \"id\" : 1306, \"channel\" : \"A\", \"sequence_num\" : 0, \"battery_ok\" : 1, \"wind_avg_mi_h\" : 4.736, \"wind_dir_deg\" : 180.000, \"rain_in\" : 41.830, \"mic\" : \"CHECKSUM\"}"),
